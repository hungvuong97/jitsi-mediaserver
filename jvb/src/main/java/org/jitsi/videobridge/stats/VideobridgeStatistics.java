    ...
    extends Statistics
{
    ...
    private void generate0()
    {
        ...
        for (Conference conference : videobridge.getConferences())
        {
            ...
            System.out.println("numConferenceEndpoints "+conference.getEndpointCount());
            int numLocalEndpoints = conference.getLocalEndpointCount();
            System.out.println("numLocalEndpoints--- "+conference.getLocalEndpointCount());
            ...
            for (Endpoint endpoint : conference.getLocalEndpoints())
            {
                ...
                System.out.println("incomingPacketsReceived-- "+incomingPacketsReceived);
